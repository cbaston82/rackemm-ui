                    ...
                    <div className="text-center px-5">
                        <div className="position-relative mr-3" style={{ top: '-62px' }}>
                            ...
                            <p className="mt-5 text-justify fw-light lead">
                                ...
                                created <span className="rackemm-text-cyan">RACKEMM</span> to solve
                                some of these problems we all have as pool players and much more.
                            </p>
                            <p className="lead">
                                ...
                                <span className="rackemm-text-cyan">RACKEMM</span> is a tool that
                                can help bridge the pool tournament scene on a global scale—making
                                it a one-stop search to find a tournament anywhere, anytime, with
                                any buy-in and more.{' '}
                                <span className="rackemm-text-cyan">RACKEMM</span> is a database for
                                all pool tournaments that will allow a player to filter through
                                every tournament entered into the system.
                            </p>
                            <p className="lead">
